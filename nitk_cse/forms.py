...
from wtforms import TextAreaField, SubmitField, StringField, PasswordField, RadioField, IntegerField
...
class FacultyLoginForm(FlaskForm):
    ...
    password = PasswordField('Password', validators=[DataRequired()])
    submit = SubmitField('Faculty Login')
...
class ProfessorForm(FlaskForm):
    name = StringField('Name', validators=[DataRequired(), Length(min=2, max=200)])
    post = RadioField('Post', validators=[DataRequired()],
                      choices=[('Professor', 'Professor'), ('Head of Department', 'Head of Department'),
